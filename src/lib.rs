...
#[derive(Debug)]
pub struct ExporterDataProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ExporterDataProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ExporterData processing");
    
    let mut processor = ExporterDataProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ExporterDataProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ExporterDataProcessor::new(false);
